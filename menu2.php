                        ...
                        <div class="col-12">
                            <div class="">
                                ...
                                <div class="container">
                                    ...
                                    <!-- <a href="" class="btn btn-default" name="tampil">Tampilkan Semua</a> -->
                                        ...
                                        <div class="card-body">
                                            <table id="example1" class="table table-striped" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    include 'config.php';
                                                    $tgl = date("Y-m-d");
                                                    $sql = mysqli_query($conn, "SELECT * FROM mast_pasien WHERE tgl_daftar = '$tgl'");
                                                    $no = 1;
                                                    ...
                                                    while ($d = mysqli_fetch_array($sql)) { ?>
                                                        <tr>
                                                            ...
                                                            <td style=" text-align: center ;">
                                                                <div class="btn-group">
                                                                    <a href="periksa.php?no_rm=<?php echo $d['no_rm']; ?>" type="button" class="btn btn-primary">Periksa</a>
                                                                    <a href="edit_pasien.php?no_rm=<?= $d['no_rm']; ?>" type="button" class="btn btn-warning">Edit</a>
                                                                    <a href="delete_pasien.php?no_rm=<?= $d['no_rm']; ?>" type="button" class="btn btn-danger" onclick="return confirm('Yakin Mau di Hapus ?');">Hapus</a>
                                                                </div>
